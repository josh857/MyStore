...
<template>
  ...
  <div class="row">
    ...
    <div style="margin-top: 50px;padding-left: 70px;" class="col-6">
      ...
      <button type="button" class="btn btn-dark" style="margin-left: 10px;"><router-link to="/Food" replace><span>Food</span></router-link></button>
      <button type="button" class="btn btn-dark" style="margin-left: 10px;"><router-link to="/Drink" replace><span>Drink</span></router-link></button>
      <button type="button" class="btn btn-dark" style="margin-left: 10px;"><router-link to="/Fruit" replace><span>Fruit</span></router-link></button>
      <router-link to="/Car"><button type="button" class="btn btn-dark position-relative" style="margin-left: 10px;" >
